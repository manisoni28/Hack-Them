...
import net.appic.hack.parser.RssAtomParser;
...
import net.appic.hack.utils.ArticleTextExtractor;
import net.appic.hack.utils.Dog;
import net.appic.hack.utils.HtmlUtils;
import net.appic.hack.utils.NetworkUtils;
...
public class FetcherService extends IntentService {
    ...
    public static final String ACTION_REFRESH_FEEDS = "net.appic.hack.REFRESH";
    public static final String ACTION_MOBILIZE_FEEDS = "net.appic.hack.MOBILIZE_FEEDS";
    public static final String ACTION_DOWNLOAD_IMAGES = "net.appic.hack.DOWNLOAD_IMAGES";
