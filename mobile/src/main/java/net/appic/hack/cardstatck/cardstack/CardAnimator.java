package net.appic.hack.cardstatck.cardstack;
...
import net.appic.hack.cardstatck.animation.RelativeLayoutParamsEvaluator;
        ...
        for (View v : mCardCollection) {
            ...
            */
            ...
            if (index == 0)// setting 0 used to add different layout shadow...
                v.setBackground(LandingActivity.context.getResources().getDrawable(R.drawable.card_stack_bg_shadow3));
            else if (index == 1)
                v.setBackground(LandingActivity.context.getResources().getDrawable(R.drawable.card_stack_bg_shadow2));
            else if (index == 2)
                v.setBackground(LandingActivity.context.getResources().getDrawable(R.drawable.card_stack_bg_shadow));
        }
    }
